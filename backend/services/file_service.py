...
class FileService:
    ...
    async def read_upload_capped(self, upload) -> bytes:
        """Read an UploadFile in 1 MB chunks, rejecting once MAX_UPLOAD_MB is
        exceeded — bounds memory instead of loading an oversized file at once."""
        chunks, total = [], 0
        while True:
