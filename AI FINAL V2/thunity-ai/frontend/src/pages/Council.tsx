      ...
      <Card title="New session" hint={mode === "fast" ? "POST /api/agents/chat" : "POST /api/agents/council"}>
        ...
        {mode === "fast" ? (
          <div className="fast-mode-head">
            <div>
              <div className="fast-mode-title">Fast Chat <span style={{ color: "var(--local)", fontSize: "11px", fontWeight: 600, letterSpacing: ".04em", marginLeft: "6px" }}>Local-Secure</span></div>
          ...
          <div className="fast-main">
            ...
            {fastTurns.length === 0 && (
              <div className="fast-empty-state">
                <div>Ask anything — responses stay local and side-effect-free.</div>
                <div className="muted small" style={{ marginTop: "4px" }}>Fast Chat can answer, summarize, and reason. It will not create tasks, decisions, workflows, or tool calls.</div>
              </div>
            )}
