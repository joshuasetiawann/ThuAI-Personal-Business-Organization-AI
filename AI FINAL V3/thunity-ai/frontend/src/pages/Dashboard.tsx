  ...
  return (
    <div className="page">
      <header className="dash-hero">
        ...
        <p className="muted dash-lede">Your private, local-first AI company operations — a fast local assistant, a strategic AI Council, knowledge, decisions, tasks, and audit, all running on your own machine. This is a read-only overview; sensitive actions stay gated behind founder approval.</p>
      </header>
      ...
      <section className="dash-briefing">
        <Card title="Founder Daily Briefing" hint="read-only · live local data">
