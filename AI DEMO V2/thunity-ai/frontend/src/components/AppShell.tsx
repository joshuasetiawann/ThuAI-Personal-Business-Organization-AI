...
const NAV: { to: string; label: string; end?: boolean; stub?: boolean }[] = [
  ...
  { to: "/council", label: "AI Council", stub: true },
  { to: "/conversations", label: "Conversations", stub: true },
  { to: "/knowledge", label: "Knowledge Vault", stub: true },
  { to: "/decisions", label: "Decisions", stub: true },
  { to: "/tasks", label: "Tasks", stub: true },
  { to: "/approvals", label: "Approvals", stub: true },
  { to: "/workflows", label: "Workflows", stub: true },
  { to: "/tools", label: "Tools", stub: true },
    ...
    <div className="shell">
      <aside className="sidebar">
        <div className="brand">
          ...
          <div><b>Thunity</b><small>Local AI Company OS</small></div>
        </div>
        <nav>
          {NAV.map((n) => (
